...
from ...models.pd.index import UpdateIndexingSchedule
from ...utils.application_tools import load_and_validate_toolkit_for_index, get_session_for_schema
        ...
        try:
            with get_session_for_schema(connection_string, toolkit_name_id) as session:
                ...
                for id, cmetadata in meta:
                    ...
                    #
                    result.append({"id": id, "metadata": cmetadata})
    ...
    def patch(self, project_id: int, toolkit_id: int, index_meta_id: str):
        ...
        try:
            with db.get_session(project_id) as session:
                ...
                # Update or add user-specific scheduling
                index_entry["schedules"][update_data.user_id] = {
            ...
            return {"ok": False, "error": f"Error occurred while updating index_meta"}, 400
