...
def generate_predict_payload(
    ...
    payload = {
        ...
        'mcp_auth_resume': bool(getattr(parsed, 'mcp_auth_resume', False)),
        'mcp_auth_action': getattr(parsed, 'mcp_auth_action', None),
        'mcp_auth_decisions': getattr(parsed, 'mcp_auth_decisions', None),
        'authorization_request_id': getattr(parsed, 'authorization_request_id', None),
